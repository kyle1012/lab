<template>
    <div class="board-detail">
      ...
      <div class="board-contents">
        <span>이메일 : {{ $route.query[10] }}</span>
      </div>
      <div class="board-contents">
        <span>유선mac : {{ $route.query[6] }}</span>
      </div>
      <div class="board-contents">
        <span>무선mac : {{ $route.query[7] }}</span>
      </div>
      <div class="board-contents">
        <span>기안일 : {{ $route.query[20] }}</span>
      </div>
      <div class="board-contents">
        <span>구분 : {{ $route.query[8] }}</span>
      </div>
      <div class="board-contents">
        <span>용도 : {{ $route.query[11] }}</span>
      </div>
      <div class="board-contents">
        <span>단말기 : {{ $route.query[12] }}</span>
      </div>
      <div class="board-contents">
        <span>내용 : {{ $route.query[15] }}</span>
      </div>
      <div class="board-contents">
